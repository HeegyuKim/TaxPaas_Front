    ...
    return (
      <div className="StatisticsView">
        ...
        <div className="Statistic ClientNumber">
          ...
          <StatisticsItem type="client" numerator="10" denominator="12"/></div>
        ...
        <div className="Statistic Meeting">
          ...
          <StatisticsItem type="meeting" numerator="6" denominator="10"/></div>
        <div className="PartitionVertical"></div>
        ...
        <div className="Statistic Email">
          ...
          <StatisticsItem type="email" numerator="10" denominator="10"/></div>
        <div className="PartitionVertical"></div>
        ...
        <div className="Statistic Docs">
          ...
          <StatisticsItem type="source" numerator="7" denominator="10"/></div>
        <div className="PartitionVertical"></div>
        ...
        <div className="Statistic Calculation">
          ...
          <StatisticsItem type="calc" numerator="6" denominator="7"/></div>
        <div className="PartitionVertical"></div>
        ...
        <div className="Statistic Review">
          ...
          <StatisticsItem type="review" numerator="2" denominator="6"/></div>
        <div className="PartitionVertical"></div>
        ...
        <div className="Statistic Efile">
          ...
          <StatisticsItem type="efile" numerator="2" denominator="2"/></div>
        <div className="PartitionVertical"></div>
        ...
        <div className="Statistic Revenue">
          ...
          <StatisticsItem type="revenue" numerator="$4200" denominator="$12400"/></div>
